...
#ifndef __LIBNCS_OMNET_CUBICMOCKFUNCTION_H_
#define __LIBNCS_OMNET_CUBICMOCKFUNCTION_H_
...
class CubicMockFunction : public CoCpnMockNcsImpl::MockFunction, public cSimpleModule {
  public:
